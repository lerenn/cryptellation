...
.PHONY: code/check
code/check:  code/check-todos code/generate code/lint code/test ## Generate, lint and test the code
...
.PHONY: code/generate
code/generate: go/generate python/generate ## Generate the code
