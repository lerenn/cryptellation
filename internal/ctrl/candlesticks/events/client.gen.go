...
type ClientSubscriber interface {
	...
	CryptellationCandlesticksListResponse(ctx context.Context, msg CandlesticksListResponseMessage, done bool)
}
...
func (c *ClientController) SubscribeCryptellationCandlesticksListResponse(ctx context.Context, fn func(ctx context.Context, msg CandlesticksListResponseMessage, done bool)) error {
	// Get channel path
...
func (c *ClientController) UnsubscribeCryptellationCandlesticksListResponse(ctx context.Context) {
	// Get channel path
	path := "cryptellation.candlesticks.list.response"
...
func (c *ClientController) PublishCryptellationCandlesticksListRequest(ctx context.Context, msg CandlesticksListRequestMessage) error {
	// Get channel path
...
func (cc *ClientController) WaitForCryptellationCandlesticksListResponse(ctx context.Context, publishMsg MessageWithCorrelationID, pub func(ctx context.Context) error) (CandlesticksListResponseMessage, error) {
	// Get channel path
	path := "cryptellation.candlesticks.list.response"
