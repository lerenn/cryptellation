...
type AppSubscriber interface {
	...
	CryptellationCandlesticksListRequest(ctx context.Context, msg CandlesticksListRequestMessage, done bool)
}
...
func (c *AppController) SubscribeCryptellationCandlesticksListRequest(ctx context.Context, fn func(ctx context.Context, msg CandlesticksListRequestMessage, done bool)) error {
	// Get channel path
