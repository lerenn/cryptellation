...
type AppSubscriber interface {
	...
	CryptellationExchangesListRequest(ctx context.Context, msg ExchangesRequestMessage, done bool)
}
...
func (c *AppController) SubscribeCryptellationExchangesListRequest(ctx context.Context, fn func(ctx context.Context, msg ExchangesRequestMessage, done bool)) error {
	// Get channel path
