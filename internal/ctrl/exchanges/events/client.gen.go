...
type ClientSubscriber interface {
	...
	CryptellationExchangesListResponse(ctx context.Context, msg ExchangesResponseMessage, done bool)
}
...
func (c *ClientController) SubscribeCryptellationExchangesListResponse(ctx context.Context, fn func(ctx context.Context, msg ExchangesResponseMessage, done bool)) error {
	// Get channel path
...
func (c *ClientController) UnsubscribeCryptellationExchangesListResponse(ctx context.Context) {
	// Get channel path
	path := "cryptellation.exchanges.list.response"
...
func (c *ClientController) PublishCryptellationExchangesListRequest(ctx context.Context, msg ExchangesRequestMessage) error {
	// Get channel path
...
func (cc *ClientController) WaitForCryptellationExchangesListResponse(ctx context.Context, publishMsg MessageWithCorrelationID, pub func(ctx context.Context) error) (ExchangesResponseMessage, error) {
	// Get channel path
	path := "cryptellation.exchanges.list.response"
