...
type AppSubscriber interface {
	...
	CryptellationIndicatorsSmaRequest(msg SmaRequestMessage, done bool)
}
...
func (c *AppController) SubscribeAll(as AppSubscriber) error {
	...
	if err := c.SubscribeCryptellationIndicatorsSmaRequest(as.CryptellationIndicatorsSmaRequest); err != nil {
		return err
	}
...
func (c *AppController) UnsubscribeAll() {
	...
	c.UnsubscribeCryptellationIndicatorsSmaRequest()
...
func (c *AppController) SubscribeCryptellationIndicatorsSmaRequest(fn func(msg SmaRequestMessage, done bool)) error {
	// Get channel path
...
func (c *AppController) UnsubscribeCryptellationIndicatorsSmaRequest() {
	// Get channel path
	path := "cryptellation.indicators.sma.request"
...
func (c *AppController) PublishCryptellationIndicatorsSmaResponse(msg SmaResponseMessage) error {
