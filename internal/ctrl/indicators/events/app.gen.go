...
type AppSubscriber interface {
	// CryptellationIndicatorsSmaRequest
	CryptellationIndicatorsSmaRequest(ctx context.Context, msg SmaRequestMessage, done bool)
}
...
func (c *AppController) SubscribeCryptellationIndicatorsSmaRequest(ctx context.Context, fn func(ctx context.Context, msg SmaRequestMessage, done bool)) error {
	// Get channel path
	...
	go func() {
		for {
			...
			// Process message
			msg, err := newSmaRequestMessageFromUniversalMessage(um)
			if err != nil {
