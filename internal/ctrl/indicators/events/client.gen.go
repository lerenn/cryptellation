...
type ClientSubscriber interface {
	...
	CryptellationIndicatorsSmaResponse(msg SmaResponseMessage, done bool)
}
...
func (c *ClientController) SubscribeAll(as ClientSubscriber) error {
	...
	if err := c.SubscribeCryptellationIndicatorsSmaResponse(as.CryptellationIndicatorsSmaResponse); err != nil {
		return err
	}
...
func (c *ClientController) UnsubscribeAll() {
	...
	c.UnsubscribeCryptellationIndicatorsSmaResponse()
...
func (c *ClientController) SubscribeCryptellationIndicatorsSmaResponse(fn func(msg SmaResponseMessage, done bool)) error {
	// Get channel path
...
func (c *ClientController) UnsubscribeCryptellationIndicatorsSmaResponse() {
	// Get channel path
	path := "cryptellation.indicators.sma.response"
...
func (c *ClientController) PublishCryptellationIndicatorsSmaRequest(msg SmaRequestMessage) error {
...
func (cc *ClientController) WaitForCryptellationIndicatorsSmaResponse(ctx context.Context, publishMsg MessageWithCorrelationID, pub func() error) (SmaResponseMessage, error) {
	// Get channel path
	path := "cryptellation.indicators.sma.response"
