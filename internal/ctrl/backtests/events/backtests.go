// Backtests
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g application -p events -i ./../../../../api/asyncapi/backtests.yaml -o ./app.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g user        -p events -i ./../../../../api/asyncapi/backtests.yaml -o ./user.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g types       -p events -i ./../../../../api/asyncapi/backtests.yaml -o ./types.gen.go
