...
func (d *DB) CreateBacktest(ctx context.Context, bt *domain.Backtest) error {
...
func (d *DB) ReadBacktest(ctx context.Context, id uint) (domain.Backtest, error) {
	bt := domain.Backtest{}
...
func (d *DB) UpdateBacktest(ctx context.Context, bt domain.Backtest) error {
	return d.client.Set(ctx, backtestKey(bt.ID), bt, 0).Err()
}

func (d *DB) DeleteBacktest(ctx context.Context, bt domain.Backtest) error {
