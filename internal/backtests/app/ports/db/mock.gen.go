...
import (
	...
	domain "github.com/digital-feather/cryptellation/internal/backtests/app/domain"
...
func (m *MockAdapter) CreateBacktest(ctx context.Context, bt *domain.Backtest) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) DeleteBacktest(ctx context.Context, bt domain.Backtest) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) ReadBacktest(ctx context.Context, id uint) (domain.Backtest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadBacktest", ctx, id)
	ret0, _ := ret[0].(domain.Backtest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAdapter) UpdateBacktest(ctx context.Context, bt domain.Backtest) error {
	m.ctrl.T.Helper()
