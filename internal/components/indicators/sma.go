...
import (
	...
	"github.com/lerenn/cryptellation/pkg/indicators/sma"
	"github.com/lerenn/cryptellation/pkg/models/timeserie"
	"github.com/lerenn/cryptellation/pkg/utils"
)

func (ind indicators) GetCachedSMA(ctx context.Context, payload GetCachedSMAPayload) (*timeserie.TimeSerie[float64], error) {
