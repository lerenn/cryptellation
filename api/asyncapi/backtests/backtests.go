// Backtests
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g application -p backtests -i ../backtests.yaml -o ./app.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g user        -p backtests -i ../backtests.yaml -o ./user.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g types       -p backtests -i ../backtests.yaml -o ./types.gen.go
