// Candlesticks
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g application -p candlesticks -i ../candlesticks.yaml -o ./app.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g user        -p candlesticks -i ../candlesticks.yaml -o ./user.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.29.0 -g types       -p candlesticks -i ../candlesticks.yaml -o ./types.gen.go
...
func (msg *ListCandlesticksRequestMessage) ToModel() (candlesticks.GetCachedPayload, error) {
