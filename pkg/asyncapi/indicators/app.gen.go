...
type AppSubscriber interface {
	// CryptellationIndicatorsSmaRequest subscribes to messages placed on the 'cryptellation.indicators.sma.request' channel
	CryptellationIndicatorsSmaRequest(ctx context.Context, msg SmaRequestMessage)
}
...
func (c *AppController) SubscribeAll(ctx context.Context, as AppSubscriber) error {
	...
	if err := c.SubscribeCryptellationIndicatorsSmaRequest(ctx, as.CryptellationIndicatorsSmaRequest); err != nil {
		return err
	}
...
func (c *AppController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribeCryptellationIndicatorsSmaRequest(ctx)
}

// SubscribeCryptellationIndicatorsSmaRequest will subscribe to new messages from 'cryptellation.indicators.sma.request' channel.
//
// Callback function 'fn' will be called each time a new message is received.
func (c *AppController) SubscribeCryptellationIndicatorsSmaRequest(ctx context.Context, fn func(ctx context.Context, msg SmaRequestMessage)) error {
	// Get channel path
	...
	go func() {
		for {
			...
			if err := c.executeMiddlewares(ctx, &brokerMsg, func(ctx context.Context) error {
				// Process message
				msg, err := newSmaRequestMessageFromBrokerMessage(brokerMsg)
				if err != nil {
					return err
				}
...
// UnsubscribeCryptellationIndicatorsSmaRequest will unsubscribe messages from 'cryptellation.indicators.sma.request' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *AppController) UnsubscribeCryptellationIndicatorsSmaRequest(ctx context.Context) {
	// Get channel path
	path := "cryptellation.indicators.sma.request"
...
// PublishCryptellationIndicatorsSmaResponse will publish messages to 'cryptellation.indicators.sma.response' channel
func (c *AppController) PublishCryptellationIndicatorsSmaResponse(ctx context.Context, msg SmaResponseMessage) error {
	// Get channel path
