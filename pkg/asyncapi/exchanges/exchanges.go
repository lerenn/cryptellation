// Exchanges
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g application -p exchanges -i ./../../../api/asyncapi/exchanges.yaml -o ./app.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g user        -p exchanges -i ./../../../api/asyncapi/exchanges.yaml -o ./user.gen.go
//go:generate go run github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@v0.26.0 -g types       -p exchanges -i ./../../../api/asyncapi/exchanges.yaml -o ./types.gen.go
