...
// newExchangesRequestMessageFromBrokerMessage will fill a new ExchangesRequestMessage with data from generic broker message
func newExchangesRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (ExchangesRequestMessage, error) {
	var msg ExchangesRequestMessage
...
// toBrokerMessage will generate a generic broker message from ExchangesRequestMessage data
func (msg ExchangesRequestMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
...
func (msg *ExchangesRequestMessage) SetCorrelationID(id string) {
...
// newExchangesResponseMessageFromBrokerMessage will fill a new ExchangesResponseMessage with data from generic broker message
func newExchangesResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (ExchangesResponseMessage, error) {
	var msg ExchangesResponseMessage
...
// toBrokerMessage will generate a generic broker message from ExchangesResponseMessage data
func (msg ExchangesResponseMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
	// TODO: implement checks on message
...
// SetCorrelationID will set the correlation ID of the message, based on AsyncAPI spec
func (msg *ExchangesResponseMessage) SetCorrelationID(id string) {
	msg.Headers.CorrelationID = &id
}
