...
type AppSubscriber interface {
	// CryptellationCandlesticksListRequest subscribes to messages placed on the 'cryptellation.candlesticks.list.request' channel
	CryptellationCandlesticksListRequest(ctx context.Context, msg CandlesticksListRequestMessage)
}
...
func (c *AppController) SubscribeAll(ctx context.Context, as AppSubscriber) error {
	...
	if err := c.SubscribeCryptellationCandlesticksListRequest(ctx, as.CryptellationCandlesticksListRequest); err != nil {
		return err
	}
...
func (c *AppController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribeCryptellationCandlesticksListRequest(ctx)
}
...
func (c *AppController) SubscribeCryptellationCandlesticksListRequest(ctx context.Context, fn func(ctx context.Context, msg CandlesticksListRequestMessage)) error {
	// Get channel path
	...
	go func() {
		for {
			...
			if err := c.executeMiddlewares(ctx, &brokerMsg, func(ctx context.Context) error {
				// Process message
				msg, err := newCandlesticksListRequestMessageFromBrokerMessage(brokerMsg)
				if err != nil {
					return err
				}
...
func (c *AppController) UnsubscribeCryptellationCandlesticksListRequest(ctx context.Context) {
	// Get channel path
	path := "cryptellation.candlesticks.list.request"
...
func (c *AppController) PublishCryptellationCandlesticksListResponse(ctx context.Context, msg CandlesticksListResponseMessage) error {
	// Get channel path
