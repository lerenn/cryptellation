...
type UserSubscriber interface {
	// CryptellationTicksListenExchangePair subscribes to messages placed on the 'cryptellation.ticks.listen.{exchange}.{pair}' channel
	CryptellationTicksListenExchangePair(ctx context.Context, msg TickMessage)

	// CryptellationTicksRegisterResponse subscribes to messages placed on the 'cryptellation.ticks.register.response' channel
	CryptellationTicksRegisterResponse(ctx context.Context, msg RegisteringResponseMessage)

	// CryptellationTicksUnregisterResponse subscribes to messages placed on the 'cryptellation.ticks.unregister.response' channel
	CryptellationTicksUnregisterResponse(ctx context.Context, msg RegisteringResponseMessage)
}
...
func (c *UserController) SubscribeCryptellationTicksListenExchangePair(ctx context.Context, params CryptellationTicksListenExchangePairParameters, fn func(ctx context.Context, msg TickMessage)) error {
	// Get channel path
...
func (c *UserController) UnsubscribeCryptellationTicksListenExchangePair(ctx context.Context, params CryptellationTicksListenExchangePairParameters) {
	// Get channel path
	path := fmt.Sprintf("cryptellation.ticks.listen.%v.%v", params.Exchange, params.Pair)
...
// Callback function 'fn' will be called each time a new message is received.
func (c *UserController) SubscribeCryptellationTicksRegisterResponse(ctx context.Context, fn func(ctx context.Context, msg RegisteringResponseMessage)) error {
	// Get channel path
...
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *UserController) UnsubscribeCryptellationTicksRegisterResponse(ctx context.Context) {
	// Get channel path
	path := "cryptellation.ticks.register.response"
...
// Callback function 'fn' will be called each time a new message is received.
func (c *UserController) SubscribeCryptellationTicksUnregisterResponse(ctx context.Context, fn func(ctx context.Context, msg RegisteringResponseMessage)) error {
	// Get channel path
...
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *UserController) UnsubscribeCryptellationTicksUnregisterResponse(ctx context.Context) {
	// Get channel path
	path := "cryptellation.ticks.unregister.response"
...
func (c *UserController) PublishCryptellationTicksRegisterRequest(ctx context.Context, msg RegisteringRequestMessage) error {
	// Get channel path
...
func (c *UserController) PublishCryptellationTicksUnregisterRequest(ctx context.Context, msg RegisteringRequestMessage) error {
	// Get channel path
...
//
// A timeout can be set in context to avoid blocking operation, if needed.
func (cc *UserController) WaitForCryptellationTicksRegisterResponse(ctx context.Context, publishMsg MessageWithCorrelationID, pub func(ctx context.Context) error) (RegisteringResponseMessage, error) {
	// Get channel path
	path := "cryptellation.ticks.register.response"
...
//
// A timeout can be set in context to avoid blocking operation, if needed.
func (cc *UserController) WaitForCryptellationTicksUnregisterResponse(ctx context.Context, publishMsg MessageWithCorrelationID, pub func(ctx context.Context) error) (RegisteringResponseMessage, error) {
	// Get channel path
	path := "cryptellation.ticks.unregister.response"
