...
type AppSubscriber interface {
	// CryptellationTicksRegisterRequest subscribes to messages placed on the 'cryptellation.ticks.register.request' channel
	CryptellationTicksRegisterRequest(ctx context.Context, msg RegisteringRequestMessage)

	// CryptellationTicksUnregisterRequest subscribes to messages placed on the 'cryptellation.ticks.unregister.request' channel
	CryptellationTicksUnregisterRequest(ctx context.Context, msg RegisteringRequestMessage)
}
...
func (c *AppController) SubscribeCryptellationTicksRegisterRequest(ctx context.Context, fn func(ctx context.Context, msg RegisteringRequestMessage)) error {
	// Get channel path
...
// Callback function 'fn' will be called each time a new message is received.
func (c *AppController) SubscribeCryptellationTicksUnregisterRequest(ctx context.Context, fn func(ctx context.Context, msg RegisteringRequestMessage)) error {
	// Get channel path
