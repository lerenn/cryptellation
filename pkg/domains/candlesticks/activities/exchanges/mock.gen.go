...
func (m *MockExchanges) GetCandlesticks(ctx context.Context, payload GetCandlesticksActivityParams) (GetCandlesticksActivityResults, error) {
	m.ctrl.T.Helper()
...
func (mr *MockExchangesMockRecorder) GetCandlesticks(ctx, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCandlesticks", reflect.TypeOf((*MockExchanges)(nil).GetCandlesticks), ctx, payload)
}
