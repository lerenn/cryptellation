...
import (
	...
	"github.com/lerenn/cryptellation/pkg/adapters/exchanges/binance/entities"
...
func (s *Service) GetCandlesticks(ctx context.Context, payload port.GetCandlesticksPayload) (*candlestick.List, error) {
	s.client.Debug = true
