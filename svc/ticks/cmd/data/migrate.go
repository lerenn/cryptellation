...
import (
	...
	"github.com/lerenn/cryptellation/svc/ticks/internal/adapters/db/sql/migrations"
...
func addCommandsToMigrationsCmd() {
	...
	migrateCmd.Flags().StringVarP(&databaseFlag, "database", "d", "ticks", "Database to migrate")
	migrateCmd.Flags().IntVarP(&portFlag, "port", "p", 6004, "Port of the database")
