...
// Message 'TickMessage' reference another one at '#/components/messages/Tick'.
...
// Message 'ListRequestMessage' reference another one at '#/components/messages/RegisteringRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'RegisterResponseMessage' reference another one at '#/components/messages/RegisteringResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.
...
// Message 'UnregisterResponseMessage' reference another one at '#/components/messages/RegisteringResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// RegisteringRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type RegisteringRequestMessageHeaders struct {
...
type RegisteringRequestMessage struct {
	...
	Headers RegisteringRequestMessageHeaders
...
// RegisteringResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type RegisteringResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type RegisteringResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers RegisteringResponseMessageHeaders
