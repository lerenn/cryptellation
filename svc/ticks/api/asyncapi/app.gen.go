...
type AppSubscriber interface {
	// RegisterToTicksRequest subscribes to messages placed on the 'cryptellation.ticks.register.request' channel
	RegisterToTicksRequest(ctx context.Context, msg RegisteringRequestMessage)

	// ServiceInfoRequest subscribes to messages placed on the 'cryptellation.ticks.service.info.request' channel
	ServiceInfoRequest(ctx context.Context, msg ServiceInfoRequestMessage)

	// UnregisterToTicksRequest subscribes to messages placed on the 'cryptellation.ticks.unregister.request' channel
	UnregisterToTicksRequest(ctx context.Context, msg RegisteringRequestMessage)
}
...
func (c *AppController) SubscribeAll(ctx context.Context, as AppSubscriber) error {
	...
	if err := c.SubscribeRegisterToTicksRequest(ctx, as.RegisterToTicksRequest); err != nil {
		return err
	}
	if err := c.SubscribeServiceInfoRequest(ctx, as.ServiceInfoRequest); err != nil {
		return err
	}
	if err := c.SubscribeUnregisterToTicksRequest(ctx, as.UnregisterToTicksRequest); err != nil {
		return err
	}
...
func (c *AppController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribeRegisterToTicksRequest(ctx)
	c.UnsubscribeServiceInfoRequest(ctx)
	c.UnsubscribeUnregisterToTicksRequest(ctx)
}

// SubscribeRegisterToTicksRequest will subscribe to new messages from 'cryptellation.ticks.register.request' channel.
//
// Callback function 'fn' will be called each time a new message is received.
func (c *AppController) SubscribeRegisterToTicksRequest(ctx context.Context, fn func(ctx context.Context, msg RegisteringRequestMessage)) error {
	// Get channel path
	...
	go func() {
		for {
			...
			if err := c.executeMiddlewares(ctx, &brokerMsg, func(ctx context.Context) error {
				// Process message
				msg, err := newRegisteringRequestMessageFromBrokerMessage(brokerMsg)
				if err != nil {
					return err
				}
...
// UnsubscribeRegisterToTicksRequest will unsubscribe messages from 'cryptellation.ticks.register.request' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *AppController) UnsubscribeRegisterToTicksRequest(ctx context.Context) {
	// Get channel path
	path := "cryptellation.ticks.register.request"
...
} // SubscribeServiceInfoRequest will subscribe to new messages from 'cryptellation.ticks.service.info.request' channel.
// Callback function 'fn' will be called each time a new message is received.
...
// UnsubscribeServiceInfoRequest will unsubscribe messages from 'cryptellation.ticks.service.info.request' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *AppController) UnsubscribeServiceInfoRequest(ctx context.Context) {
	...
	c.logger.Info(ctx, "Unsubscribed from channel")
} // SubscribeUnregisterToTicksRequest will subscribe to new messages from 'cryptellation.ticks.unregister.request' channel.
// Callback function 'fn' will be called each time a new message is received.
func (c *AppController) SubscribeUnregisterToTicksRequest(ctx context.Context, fn func(ctx context.Context, msg RegisteringRequestMessage)) error {
	// Get channel path
...
// UnsubscribeUnregisterToTicksRequest will unsubscribe messages from 'cryptellation.ticks.unregister.request' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *AppController) UnsubscribeUnregisterToTicksRequest(ctx context.Context) {
	// Get channel path
	path := "cryptellation.ticks.unregister.request"
...
// PublishWatchTicks will publish messages to 'cryptellation.ticks.live.{exchange}.{pair}' channel
func (c *AppController) PublishWatchTicks(ctx context.Context, params CryptellationTicksLiveParameters, msg TickMessage) error {
	// Get channel path
...
// PublishRegisterToTicksResponse will publish messages to 'cryptellation.ticks.register.response' channel
func (c *AppController) PublishRegisterToTicksResponse(ctx context.Context, msg RegisteringResponseMessage) error {
	// Get channel path
...
// PublishServiceInfoResponse will publish messages to 'cryptellation.ticks.service.info.response' channel
...
// PublishUnregisterToTicksResponse will publish messages to 'cryptellation.ticks.unregister.response' channel
func (c *AppController) PublishUnregisterToTicksResponse(ctx context.Context, msg RegisteringResponseMessage) error {
	// Get channel path
