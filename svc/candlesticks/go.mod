module github.com/lerenn/cryptellation/svc/candlesticks

go 1.21.3

replace github.com/lerenn/cryptellation/pkg => ../../pkg

replace github.com/lerenn/cryptellation/svc/exchanges => ../exchanges
...
require (
	...
	github.com/lerenn/asyncapi-codegen v0.37.0
