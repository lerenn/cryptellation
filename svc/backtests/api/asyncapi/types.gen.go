...
// Message 'AccountsListRequestMessage' reference another one at '#/components/messages/AccountsListRequest'.
...
// Message 'AccountsListResponseMessage' reference another one at '#/components/messages/AccountsListResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'AdvanceRequestMessage' reference another one at '#/components/messages/AdvanceRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'AdvanceResponseMessage' reference another one at '#/components/messages/AdvanceResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'CreateRequestMessage' reference another one at '#/components/messages/CreateRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'CreateResponseMessage' reference another one at '#/components/messages/CreateResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.
...
// Message 'EventMessage' reference another one at '#/components/messages/Event'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'OrdersCreateRequestMessage' reference another one at '#/components/messages/OrdersCreateRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'OrdersCreateResponseMessage' reference another one at '#/components/messages/OrdersCreateResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'OrdersListRequestMessage' reference another one at '#/components/messages/OrdersListRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'OrdersListResponseMessage' reference another one at '#/components/messages/OrdersListResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'ServiceInfoRequestMessage' reference another one at '#/components/messages/ServiceInfoRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'ServiceInfoResponseMessage' reference another one at '#/components/messages/ServiceInfoResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'SubscribeRequestMessage' reference another one at '#/components/messages/SubscribeRequest'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// Message 'SubscribeResponseMessage' reference another one at '#/components/messages/SubscribeResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.

// AccountsListRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type AccountsListRequestMessageHeaders struct {
...
type AccountsListRequestMessage struct {
	...
	Headers AccountsListRequestMessageHeaders
...
// newAccountsListRequestMessageFromBrokerMessage will fill a new AccountsListRequestMessage with data from generic broker message
func newAccountsListRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (AccountsListRequestMessage, error) {
	var msg AccountsListRequestMessage
...
// AccountsListResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type AccountsListResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type AccountsListResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers AccountsListResponseMessageHeaders
...
// newAccountsListResponseMessageFromBrokerMessage will fill a new AccountsListResponseMessage with data from generic broker message
func newAccountsListResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (AccountsListResponseMessage, error) {
	var msg AccountsListResponseMessage
...
// AdvanceRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type AdvanceRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type AdvanceRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers AdvanceRequestMessageHeaders
...
// newAdvanceRequestMessageFromBrokerMessage will fill a new AdvanceRequestMessage with data from generic broker message
func newAdvanceRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (AdvanceRequestMessage, error) {
	var msg AdvanceRequestMessage
...
// AdvanceResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type AdvanceResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type AdvanceResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers AdvanceResponseMessageHeaders
...
// newAdvanceResponseMessageFromBrokerMessage will fill a new AdvanceResponseMessage with data from generic broker message
func newAdvanceResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (AdvanceResponseMessage, error) {
	var msg AdvanceResponseMessage
...
// CreateRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type CreateRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type CreateRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers CreateRequestMessageHeaders
...
// newCreateRequestMessageFromBrokerMessage will fill a new CreateRequestMessage with data from generic broker message
func newCreateRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (CreateRequestMessage, error) {
	var msg CreateRequestMessage
...
// CreateResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type CreateResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type CreateResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers CreateResponseMessageHeaders
...
// newCreateResponseMessageFromBrokerMessage will fill a new CreateResponseMessage with data from generic broker message
func newCreateResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (CreateResponseMessage, error) {
	var msg CreateResponseMessage
...
// ContentProperty is a schema from the AsyncAPI specification required in messages
...
// newEventMessageFromBrokerMessage will fill a new EventMessage with data from generic broker message
func newEventMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (EventMessage, error) {
	var msg EventMessage
...
// OrdersCreateRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type OrdersCreateRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type OrdersCreateRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers OrdersCreateRequestMessageHeaders
...
// newOrdersCreateRequestMessageFromBrokerMessage will fill a new OrdersCreateRequestMessage with data from generic broker message
func newOrdersCreateRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (OrdersCreateRequestMessage, error) {
	var msg OrdersCreateRequestMessage
...
// OrdersCreateResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type OrdersCreateResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type OrdersCreateResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers OrdersCreateResponseMessageHeaders
...
// newOrdersCreateResponseMessageFromBrokerMessage will fill a new OrdersCreateResponseMessage with data from generic broker message
func newOrdersCreateResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (OrdersCreateResponseMessage, error) {
	var msg OrdersCreateResponseMessage
...
// OrdersListRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type OrdersListRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type OrdersListRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers OrdersListRequestMessageHeaders
...
// newOrdersListRequestMessageFromBrokerMessage will fill a new OrdersListRequestMessage with data from generic broker message
func newOrdersListRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (OrdersListRequestMessage, error) {
	var msg OrdersListRequestMessage
...
// OrdersListResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type OrdersListResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type OrdersListResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers OrdersListResponseMessageHeaders
...
// newOrdersListResponseMessageFromBrokerMessage will fill a new OrdersListResponseMessage with data from generic broker message
func newOrdersListResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (OrdersListResponseMessage, error) {
	var msg OrdersListResponseMessage
...
// ServiceInfoRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type ServiceInfoRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type ServiceInfoRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers ServiceInfoRequestMessageHeaders
...
// ServiceInfoResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type ServiceInfoResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type ServiceInfoResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers ServiceInfoResponseMessageHeaders
...
// SubscribeRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type SubscribeRequestMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
...
type SubscribeRequestMessage struct {
	// Headers will be used to fill the message headers
	Headers SubscribeRequestMessageHeaders
...
// newSubscribeRequestMessageFromBrokerMessage will fill a new SubscribeRequestMessage with data from generic broker message
func newSubscribeRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (SubscribeRequestMessage, error) {
	var msg SubscribeRequestMessage
...
// SubscribeResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type SubscribeResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type SubscribeResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers SubscribeResponseMessageHeaders
...
// newSubscribeResponseMessageFromBrokerMessage will fill a new SubscribeResponseMessage with data from generic broker message
func newSubscribeResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (SubscribeResponseMessage, error) {
	var msg SubscribeResponseMessage
