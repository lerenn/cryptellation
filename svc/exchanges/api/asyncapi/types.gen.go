...
// Message 'ListRequestMessage' reference another one at '#/components/messages/ListRequest'.
...
// Message 'ListResponseMessage' reference another one at '#/components/messages/ListResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.
...
// ListRequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type ListRequestMessageHeaders struct {
...
type ListRequestMessage struct {
	...
	Headers ListRequestMessageHeaders
...
// newListRequestMessageFromBrokerMessage will fill a new ListRequestMessage with data from generic broker message
func newListRequestMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (ListRequestMessage, error) {
	var msg ListRequestMessage
...
// ListResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type ListResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type ListResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers ListResponseMessageHeaders
...
// newListResponseMessageFromBrokerMessage will fill a new ListResponseMessage with data from generic broker message
func newListResponseMessageFromBrokerMessage(bMsg extensions.BrokerMessage) (ListResponseMessage, error) {
	var msg ListResponseMessage
