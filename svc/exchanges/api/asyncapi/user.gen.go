...
func (c *UserController) RequestToListOperation(
	...
	for {
		...
		case acknowledgeableBrokerMessage, open := <-sub.MessagesChannel():
			...
			// Get new message
			rmsg, err := newListResponseMessageFromBrokerMessage(acknowledgeableBrokerMessage.BrokerMessage)
			if err != nil {
				c.logger.Error(ctx, err.Error())
			}
			...
			return newListResponseMessageFromBrokerMessage(acknowledgeableBrokerMessage.BrokerMessage)
