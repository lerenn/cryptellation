...
// Message 'SMARequestMessage' reference another one at '#/components/messages/SMARequest'.
...
// Message 'ListResponseMessage' reference another one at '#/components/messages/SMAResponse'.
// This should be fixed in a future version to allow message override.
// If you encounter this message, feel free to open an issue on this subject
// to let know that you need this functionnality.
...
// SMARequestMessageHeaders is a schema from the AsyncAPI specification required in messages
type SMARequestMessageHeaders struct {
...
type SMARequestMessage struct {
	...
	Headers SMARequestMessageHeaders
...
// SMAResponseMessageHeaders is a schema from the AsyncAPI specification required in messages
type SMAResponseMessageHeaders struct {
	// Description: Correlation ID set by client
	CorrelationId *string `json:"correlationId"`
}
...
type SMAResponseMessage struct {
	// Headers will be used to fill the message headers
	Headers SMAResponseMessageHeaders
...
// Description: A list of timed numbers
type NumericTimeSerieSchema []NumericTimeSerieSchemaItem

// NumericTimeSerieSchemaItem is a schema from the AsyncAPI specification required in messages
type NumericTimeSerieSchemaItem struct {
	// Description: Date-Time format according to RFC3339
