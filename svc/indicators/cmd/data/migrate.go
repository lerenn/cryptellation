...
import (
	...
	"github.com/lerenn/cryptellation/svc/indicators/internal/adapters/db/sql/migrations"
...
func addCommandsToMigrationsCmd() {
	...
	migrateCmd.Flags().StringVarP(&databaseFlag, "database", "d", "indicators", "Database to migrate")
	migrateCmd.Flags().IntVarP(&portFlag, "port", "p", 6003, "Port of the database")
